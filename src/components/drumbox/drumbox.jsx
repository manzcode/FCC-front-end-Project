...
const Button = ({children, onClick, onKeyDown, id}) => {
    ...
    return <button className="col-lg-3 m-2 btn btn-info" onClick={handleClick} onKeyPress={onKeyDown} >
        {children}
    </button>
}
...
export default function Drumbox () {
    ...
    return <>
    <h4 className="text-center"> Press the key </h4>
    <div className="container border" >
        ...
        <div className="row">
            ...
            <div className="col-lg-4 text-center">
                ...
                <p>
                <h6> Bank {bank ? " on" : " off"}</h6> 
                    <label className="switch">
                    <input type="checkbox"  onClick={() => setBank(b => !b)}/>
                    <span className="slider round"></span>
                </label>
                </p>
            </div>
